...
For example, let's install the 1.28.1-maarlab1 release of the plugin, for an Intel based
64 bit server. First, we download the right `.deb` file.

```sh
wget https://github.com/cloudnative-pg/cloudnative-pg/releases/download/v1.28.1-maarlab1/kubectl-cnpg_1.28.1-maarlab1_linux_x86_64.deb \
...
Unpacking cnpg (1.28.1-maarlab1) ...
Setting up cnpg (1.28.1-maarlab1) ...
```

#### RPM packages

As in the example for `.rpm` packages, let's install the 1.28.1-maarlab1 release for an
Intel 64 bit machine. Note the `--output` flag to provide a file name.

```sh
curl -L https://github.com/cloudnative-pg/cloudnative-pg/releases/download/v1.28.1-maarlab1/kubectl-cnpg_1.28.1-maarlab1_linux_x86_64.rpm \
...
====================================================================================================
Installing:
 cnpg               x86_64               1.28.1-maarlab1-1                  @commandline                20 M
...
----       -----------  ----------------  ------  ---         ---------------  ----
sandbox-1  0/604DE38    Primary           OK      BestEffort  1.28.1-maarlab1           k8s-eu-worker
sandbox-2  0/604DE38    Standby (async)   OK      BestEffort  1.28.1-maarlab1           k8s-eu-worker2
sandbox-3  0/604DE38    Standby (async)   OK      BestEffort  1.28.1-maarlab1           k8s-eu-worker
```
...
Name       Current LSN  Replication role  Status  QoS         Manager Version  Node
----       -----------  ----------------  ------  ---         ---------------  ----
sandbox-1  0/6053720    Primary           OK      BestEffort  1.28.1-maarlab1           k8s-eu-worker
sandbox-2  0/6053720    Standby (async)   OK      BestEffort  1.28.1-maarlab1           k8s-eu-worker2
sandbox-3  0/6053720    Standby (async)   OK      BestEffort  1.28.1-maarlab1           k8s-eu-worker
```
...
2023-03-28T12:56:41.251711811Z {"level":"info","ts":"2023-03-28T12:56:41Z","logger":"setup","msg":"Starting CloudNativePG Operator","version":"1.28.1-maarlab1","build":{"Version":"1.28.1-maarlab1+dev107","Commit":"cc9bab17","Date":"2023-03-28"}}
2023-03-28T12:56:41.251851909Z {"level":"info","ts":"2023-03-28T12:56:41Z","logger":"setup","msg":"Starting pprof HTTP server","addr":"0.0.0.0:6060"}
  <snipped …>

====== End of Previous Log =====
2023-03-28T12:57:09.854306024Z {"level":"info","ts":"2023-03-28T12:57:09Z","logger":"setup","msg":"Starting CloudNativePG Operator","version":"1.28.1-maarlab1","build":{"Version":"1.28.1-maarlab1+dev107","Commit":"cc9bab17","Date":"2023-03-28"}}
